    ...
    private async Task PollAndScheduleRunsAsync(CancellationToken cancellationToken)
    {
        ...
        foreach (long campaignId in dueCampaignIds)
        {
            ...
            try
            {
                ...
                {
                    logger.LogWarning("Campaign {CampaignId} is a dynamic campaign; disbursements require preview-confirmed manual execution or contract assessment.", campaign.Id);
                    continue;
                }
