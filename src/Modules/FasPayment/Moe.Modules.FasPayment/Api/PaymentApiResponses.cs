...
internal static class PaymentApiResponses
{
    ...
    private static int StatusCode(Error error) => error.Code switch
    {
        ...
        "PAYMENT.CHECKOUT_CONFLICT" or "PAYMENT.STATEMENT_PAYMENT_IN_PROGRESS" or "PAYMENT.REFUND_EXCEEDS_PAYMENT" or "PAYMENT.INSUFFICIENT_BALANCE" or "PAYMENT.CANCELLATION_NOT_ALLOWED" => ApiResponseCodes.Conflict,
