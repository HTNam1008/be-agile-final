...
internal sealed class FasTierCriteria : Entity<long>
{
        ...
        string? connectorToNext, int displayOrder, DateTime utcNow, long entityId = 0)
    {
        ...
        return new FasTierCriteria { Id = entityId, FasTierId = tierId, CriteriaType = type, NumberFrom = numberFrom, NumberTo = numberTo, ConnectorToNext = connector, DisplayOrder = displayOrder, CreatedAtUtc = utcNow };
    }
}
