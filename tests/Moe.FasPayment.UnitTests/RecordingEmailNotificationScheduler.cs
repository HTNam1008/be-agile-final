...
{
    private readonly IEmailDeliverySwitch _mailSwitch = mailSwitch ?? new EnabledEmailDeliverySwitch();
    ...
    private sealed class EnabledEmailDeliverySwitch : IEmailDeliverySwitch
    {
