...
public sealed class FasStudentWorkflowTests
{
    ...
    [Fact] public void Submitted_application_is_locked() { var app = Draft(); app.SubmitDraft(1, DateTime.UtcNow); var act = () => app.UpdateEmail("student@example.test", 1, DateTime.UtcNow); act.Should().Throw<DomainException>(); }
