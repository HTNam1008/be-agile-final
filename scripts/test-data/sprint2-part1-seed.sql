...
(
    SELECT *
    FROM (VALUES
        (920001, 910001, 'QA-A-001', 'BACHELOR', 'QA-A1', 'ACTIVE', NULL, NULL),
        (920002, 910002, 'QA-A-002', 'BACHELOR', 'QA-A2', 'ACTIVE', NULL, NULL),
        (920003, 910003, 'QA-A-003', 'BACHELOR', 'QA-B1', 'ACTIVE', NULL, NULL),
        (920004, 910004, 'QA-A-004', 'BACHELOR', 'QA-B2', 'ACTIVE', NULL, NULL),
        (920005, 910005, 'QA-A-005', 'BACHELOR', 'QA-A1', 'ACTIVE', NULL, NULL),
        (920006, 910006, 'QA-A-006', 'BACHELOR', 'QA-A2', 'ACTIVE', NULL, NULL),
        (920007, 910007, 'QA-A-007', 'BACHELOR', 'QA-B1', 'ACTIVE', NULL, NULL),
        (920008, 910008, 'QA-A-008', 'BACHELOR', 'QA-B2', 'ACTIVE', NULL, NULL),
        (920009, 910009, 'QA-A-009', 'BACHELOR', 'QA-A1', 'ACTIVE', NULL, NULL),
        (920010, 910010, 'QA-A-010', 'BACHELOR', 'QA-A2', 'ACTIVE', NULL, NULL),
        (920011, 910011, 'QA-A-011', 'BACHELOR', 'QA-B1', 'ACTIVE', NULL, NULL),
        (920012, 910012, 'QA-A-012', 'BACHELOR', 'QA-B2', 'ACTIVE', NULL, NULL),
        (920013, 910013, 'QA-A-013', 'BACHELOR', 'QA-A1', 'ACTIVE', NULL, NULL),
        (920014, 910014, 'QA-A-014', 'BACHELOR', 'QA-A2', 'ACTIVE', NULL, NULL),
        (920015, 910015, 'QA-A-015', 'BACHELOR', 'QA-B1', 'ACTIVE', NULL, NULL),
        (920016, 910016, 'QA-A-016', 'BACHELOR', 'QA-B2', 'ACTIVE', NULL, NULL),
        (920017, 910017, 'QA-A-017', 'BACHELOR', 'QA-A1', 'ACTIVE', NULL, NULL),
        (920018, 910018, 'QA-A-018', 'BACHELOR', 'QA-A2', 'ACTIVE', NULL, NULL),
        (920019, 910019, 'QA-A-019', 'BACHELOR', 'QA-B1', 'ACTIVE', NULL, NULL),
        (920020, 910020, 'QA-A-020', 'BACHELOR', 'QA-B2', 'ACTIVE', NULL, NULL),
        (920021, 910021, 'QA-A-021', 'BACHELOR', 'QA-A1', 'ACTIVE', NULL, NULL),
        (920022, 910022, 'QA-A-022', 'BACHELOR', 'QA-A2', 'ACTIVE', NULL, NULL),
        (920023, 910023, 'QA-A-023', 'BACHELOR', 'QA-B1', 'ACTIVE', NULL, NULL),
        (920024, 910024, 'QA-A-024', 'BACHELOR', 'QA-B2', 'WITHDRAWN', 'QA_NOT_ENROLLED', '2025-12-31'),
        (920025, 910025, 'QA-A-025', 'BACHELOR', 'QA-A1', 'GRADUATED', 'QA_NOT_ENROLLED', '2025-12-31'),
        (920026, 910026, 'QA-A-026', 'BACHELOR', 'QA-A2', 'ON_LEAVE', 'QA_NOT_ENROLLED', '2025-12-31')
...
(
    SELECT *
    FROM (VALUES
        (920027, 910027, 'QA-B-001', 'BACHELOR', 'QA-C1', 'ACTIVE', NULL, NULL),
        (920028, 910028, 'QA-B-002', 'BACHELOR', 'QA-C2', 'ACTIVE', NULL, NULL),
        (920029, 910029, 'QA-B-003', 'BACHELOR', 'QA-D1', 'ACTIVE', NULL, NULL),
        (920030, 910030, 'QA-B-004', 'BACHELOR', 'QA-D2', 'WITHDRAWN', 'QA_NOT_ENROLLED', '2025-12-31')
    ) v(SchoolEnrollmentId, PersonId, StudentNumber, LevelCode, ClassCode, SchoolingStatusCode, StatusReasonCode, EndDateText)
)
INSERT INTO person.SchoolEnrollment
    (SchoolEnrollmentId, PersonId, OrganizationId, StudentNumber, AcademicYear, LevelCode, ClassCode,
